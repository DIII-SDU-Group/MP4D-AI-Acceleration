...
// ==============================================================
`timescale 1ns/1ps
module invert_image_BUS_A_s_axi
#(parameter
    ...
    input  wire [18:0]                   image_in_address0,
    input  wire                          image_in_ce0,
    output wire [7:0]                    image_in_q0,
    input  wire [18:0]                   image_out_address0,
...
localparam
    ...
    ADDR_IER            = 21'h000008,
    ADDR_ISR            = 21'h00000c,
    ADDR_IMAGE_IN_BASE  = 21'h080000,
    ADDR_IMAGE_IN_HIGH  = 21'h0fffff,
    ADDR_IMAGE_OUT_BASE = 21'h100000,
    ADDR_IMAGE_OUT_HIGH = 21'h17ffff,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [1:0]                    int_image_in_shift;
    wire [16:0]                   int_image_out_address0;
    wire                          int_image_out_ce0;
    wire                          int_image_out_we0;
    wire [3:0]                    int_image_out_be0;
    wire [31:0]                   int_image_out_d0;
    wire [31:0]                   int_image_out_q0;
    wire [16:0]                   int_image_out_address1;
    ...
    reg  [1:0]                    int_image_out_shift;

//------------------------Instantiation------------------
// int_image_in
invert_image_BUS_A_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 76800 )
) int_image_in (
    .clk0     ( ACLK ),
...
assign RVALID  = (rstate == RDDATA) & !int_image_in_read & !int_image_out_read;
...
assign int_image_in_we0       = 1'b0;
assign int_image_in_be0       = 1'b0;
assign int_image_in_d0        = 1'b0;
assign image_in_q0            = int_image_in_q0 >> (int_image_in_shift * 8);
assign int_image_in_address1  = ar_hs? raddr[18:2] : waddr[18:2];
assign int_image_in_ce1       = ar_hs | (int_image_in_write & WVALID);
assign int_image_in_we1       = int_image_in_write & w_hs;
assign int_image_in_be1       = WSTRB;
assign int_image_in_d1        = WDATA;
// image_out
assign int_image_out_address0 = image_out_address0 >> 2;
assign int_image_out_ce0      = image_out_ce0;
assign int_image_out_we0      = image_out_we0;
assign int_image_out_be0      = 1 << image_out_address0[1:0];
assign int_image_out_d0       = {4{image_out_d0}};
assign int_image_out_address1 = ar_hs? raddr[18:2] : waddr[18:2];
assign int_image_out_ce1      = ar_hs | (int_image_out_write & WVALID);
assign int_image_out_we1      = int_image_out_write & w_hs;
assign int_image_out_be1      = WSTRB;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (image_in_ce0)
            int_image_in_shift <= image_in_address0[1:0];
    end
end
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (image_out_ce0)
            int_image_out_shift <= image_out_address0[1:0];
    end
end
...
module invert_image_BUS_A_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
